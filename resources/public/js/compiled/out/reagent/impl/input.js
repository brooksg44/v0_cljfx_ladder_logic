...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__3301){
var map__3302 = p__3301;
var map__3302__$1 = cljs.core.__destructure_map.call(null,map__3302);
var on_write = cljs.core.get.call(null,map__3302__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__3303 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__3304 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__3304);

try{return reagent.impl.input.input_component_set_value.call(null,component);
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__3303);
}}));
} else {
...
(jsprops.onChange = (function (p1__3305_SHARP_){
return reagent.impl.input.input_handle_change.call(null,this$,on_change,p1__3305_SHARP_);
}));
